...
public class PruebaOrdenPersonas {
    ...
    public static void main(String[] args) {
        ...
        //Saca una copia del proyecto anterior y modifícalo para que se ordene por edad ascendente y, en el caso de que dos personas tengan la misma edad, entonces ordenará por nombre en orden alfabético ascendente.
        System.out.println(personaLista);
